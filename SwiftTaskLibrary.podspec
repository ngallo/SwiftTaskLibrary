#
#  Be sure to run `pod spec lint SwiftTaskLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/ngallo/SwiftTaskLibrary.git", :tag => "2.0.5" }
  ...
  s.source_files  = "SwiftTaskLibrary/**/*.{h,swift}"
